...
export const products: Product[] = [
  ...
  },
  {
    ...
    variants: [
      { id: 'tshirt-cruise-graphic', label: 'Cruise Graphic Tee', image: '/images/products/tshirt.png' },
      { id: 'tshirt-ship-life', label: 'Ship Life Tee', image: '/images/products/tshirt.png' },
      { id: 'tshirt-family-cruise', label: 'Family Cruise Tee', image: '/images/products/tshirt.png' },
      { id: 'tshirt-carnival-logo', label: 'Carnival Logo Tee', image: '/images/products/tshirt.png' },
      { id: 'tshirt-anchor', label: 'Anchor Design Tee', image: '/images/products/tshirt.png' },
      { id: 'tshirt-sunset', label: 'Sunset Cruise Tee', image: '/images/products/tshirt.png' },
    ],
  },
