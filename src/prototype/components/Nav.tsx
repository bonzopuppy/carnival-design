...
const drawerNavItems = [
  ...
  { label: 'My Projects', path: '/prototype/book/demo', svgPath: 'M9.27273 2.14844H2V22.1484H9.27273V2.14844ZM6.54545 13.9666H4.72727V18.5121H6.54545V13.9666ZM11.0909 7.60298H14.7273V22.1484H11.0909V7.60298ZM16.5455 4.87571H22V22.1484H16.5455V4.87571ZM18.3636 15.7848H20.1818V18.5121H18.3636V15.7848Z', directFill: '#3773AD' },
...
export default function Nav() {
  ...
  return (
    <div className="shrink-0">
      ...
      {/* Main Top Nav — 80px at 1440px+, 64px below */}
      <nav className="bg-white h-16 xl:h-[80px]">
        <div
