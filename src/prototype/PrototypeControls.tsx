...
const flows: Record<string, FlowStep[]> = {
  'pre-cruise': [
    ...
    { label: 'Cart', path: '/prototype/cart' },
    { label: 'Checkout', path: '/prototype/checkout' },
    { label: 'Confirmation', path: '/prototype/confirmation' },
  ],
  'in-cruise': [
    { label: 'Splash', path: '/prototype/home' },
    { label: 'Homepage', path: '/prototype/book/demo' },
  ...
  'post-cruise': [
    ...
    { label: 'Homepage', path: '/prototype/book/demo' },
    { label: 'Marketplace', path: '/prototype/marketplace' },
    { label: 'PDP', path: '/prototype/marketplace/product/wall-calendar' },
    { label: 'Editor', path: '/prototype/editor/wall-calendar' },
    { label: 'Cart', path: '/prototype/cart' },
    { label: 'Checkout', path: '/prototype/checkout' },
    { label: 'Confirmation', path: '/prototype/confirmation' },
  ],
  none: [
    ...
    { label: 'Checkout', path: '/prototype/checkout' },
    { label: 'Confirmation', path: '/prototype/confirmation' },
    { label: 'Order History', path: '/prototype/order-history' },
  ],
}
